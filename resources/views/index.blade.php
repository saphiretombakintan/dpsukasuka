...
<head>
    ...
    <!-- Toastr style -->
    <link href="{{asset('front-end/css/plugins/toastr/toastr.min.css')}}" rel="stylesheet">

    <!-- Gritter -->
    <link href="{{asset('front-end/js/plugins/gritter/jquery.gritter.css')}}" rel="stylesheet">
...
<body>
    ...
    <script src="{{asset('front-end/js/plugins/metisMenu/jquery.metisMenu.js')}}"></script>
    <script src="{{asset('front-end/js/plugins/slimscroll/jquery.slimscroll.min.js')}}"></script>

    <!-- Flot -->
    <script src="{{asset('front-end/js/plugins/flot/jquery.flot.js')}}"></script>
    <script src="{{asset('front-end/js/plugins/flot/jquery.flot.tooltip.min.js')}}"></script>
    <script src="{{asset('front-end/js/plugins/flot/jquery.flot.spline.js')}}"></script>
    <script src="{{asset('front-end/js/plugins/flot/jquery.flot.resize.js')}}"></script>
    <script src="{{asset('front-end/js/plugins/flot/jquery.flot.pie.js')}}"></script>

    <!-- Peity -->
    <script src="{{asset('front-end/js/plugins/peity/jquery.peity.min.js')}}"></script>
    <script src="{{asset('front-end/js/demo/peity-demo.js')}}"></script>

    <!-- Custom and plugin javascript -->
    <script src="{{asset('front-end/js/inspinia.js')}}"></script>
    <script src="{{asset('front-end/js/plugins/pace/pace.min.js')}}"></script>

    <!-- jQuery UI -->
    <script src="{{asset('front-end/js/plugins/jquery-ui/jquery-ui.min.js')}}"></script>

    <!-- GITTER -->
    <script src="{{asset('front-end/js/plugins/gritter/jquery.gritter.min.js')}}"></script>

    <!-- Sparkline -->
    <script src="{{asset('front-end/js/plugins/sparkline/jquery.sparkline.min.js')}}"></script>

    <!-- Sparkline demo data  -->
    <script src="{{asset('front-end/js/demo/sparkline-demo.js')}}"></script>

    <!-- ChartJS-->
    <script src="{{asset('front-end/js/plugins/chartJs/Chart.min.js')}}"></script>

    <!-- Toastr -->
    <script src="{{asset('front-end/js/plugins/toastr/toastr.min.js')}}"></script>
